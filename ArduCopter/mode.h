...
public:
    ...
    enum class Number : uint8_t {
        ...
        MAX_ALT_HOLD = 30, // Custom ALT_HOLD mode with altitude limit
...
class ModeMaxAltHold : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::MAX_ALT_HOLD; }
...
protected:
    ...
    const char *name() const override { return "MAX_ALT_HOLD"; }
    const char *name4() const override { return "MXALTH"; }
